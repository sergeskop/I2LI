...
namespace I2LI.DataAccess.Repositories.PrivateClasses.Tests
{
    ...
    {
        [TestMethod]
        public void ClassInfoRepoTests_GetAllClassCategories()
        {
        ...
        [TestMethod]
        public void ClassInfoRepoTests_GetClassCategoryByKeyword()
        {
            using (PrivateClassesDBContext dbContext = new PrivateClassesDBContext())
            {
                ClassInfoRepo repo = new ClassInfoRepo(dbContext);
        ...
        [TestMethod]
        public void ClassInfoRepoTests_GetAllClasses()
        {
            using (PrivateClassesDBContext dbContext = new PrivateClassesDBContext())
            {
                ClassInfoRepo repo = new ClassInfoRepo(dbContext);
        ...
        [TestMethod]
        public void ClassInfoRepoTests_GetAll()
        {
            using (PrivateClassesDBContext dbContext = new PrivateClassesDBContext())
            {
                ClassInfoRepo repo = new ClassInfoRepo(dbContext);
        ...
        [TestMethod]
        public void GenericRepoTests_GetAll()
        {
            using (PrivateClassesDBContext dbContext = new PrivateClassesDBContext())
            {
        ...
        [TestMethod]
        public void ClassInfoRepoTests_FindMany()
        {
            using (PrivateClassesDBContext dbContext = new PrivateClassesDBContext())
            {
                GenericRepository<ClassInfo> repo = new GenericRepository<ClassInfo>(dbContext);
        ...
        [TestMethod]
        public void ClassInfoRepoTests_FindOne()
        {
            using (PrivateClassesDBContext dbContext = new PrivateClassesDBContext())
            {
                GenericRepository<ClassInfo> repo = new GenericRepository<ClassInfo>(dbContext);
        ...
        [TestMethod]
        public void ClassInfoRepoTests_GetClassById()
        {
            using (PrivateClassesDBContext dbContext = new PrivateClassesDBContext())
            {
                ClassInfoRepo repo = new ClassInfoRepo(dbContext);
        ...
        [TestMethod]
        public void ClassInfoRepoTests_FindFullyPaidClasses()
        {
            using (PrivateClassesDBContext dbContext = new PrivateClassesDBContext())
            {
                ClassInfoRepo repo = new ClassInfoRepo(dbContext);
        ...
        [TestMethod]
        public void ClassInfoRepoTests_FindUnPaidClasses()
        {
            using (PrivateClassesDBContext dbContext = new PrivateClassesDBContext())
            {
                ClassInfoRepo repo = new ClassInfoRepo(dbContext);
